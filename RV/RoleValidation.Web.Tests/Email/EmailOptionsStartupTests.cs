...
{
    [Fact]
    public async Task StartAsync_Should_RejectMissingEmailSection()
    {
    ...
    [Fact]
    public async Task StartAsync_Should_RejectPartialEmailSection()
    {
        using IHost host = BuildHost(new Dictionary<string, string?>
        {
            ["RoleValidation:DataSource"] = "Hybrid",
    ...
    [InlineData("Hybrid")]
    [InlineData("Oracle")]
    public async Task StartAsync_Should_RejectDevelopmentApiEmail(
        string dataSource)
    {
        using IHost host = BuildHost(new Dictionary<string, string?>
        {
    ...
    public async Task StartAsync_Should_RejectInvalidOracleArtifactRoot(
        string artifactRoot)
    {
        using IHost host = BuildHost(new Dictionary<string, string?>
        {
    ...
    [Fact]
    public async Task StartAsync_Should_RejectOracleArtifactRootWithSurroundingWhitespace()
    {
    ...
    [Fact]
    public async Task StartAsync_Should_RejectOracleRootThatExceedsOwnerWorkbookStoragePathLimit()
    {
